...
% inputenc is pdfTeX-only; guard it so the paper also compiles under
% XeTeX/LuaTeX-based engines (e.g. tectonic), which are natively UTF-8.
\usepackage{iftex}
\ifPDFTeX
...
% ---- Blind-review toggle ---------------------------------------------------
% Compile main.tex for the regular PDF; compile main_blind.tex (which defines
% \BLIND and inputs this file) for the anonymized RFS submission copy.
\newif\ifblind
\ifdefined\BLIND \blindtrue \else \blindfalse \fi
% Accessibility: visible alternative-text description beneath figure captions,
% per SFS/RFS submission guidelines.
\newcommand{\alttext}[1]{\par\vspace{0.2em}\noindent{\footnotesize \emph{Alt text:} #1}}
...
\noindent 
Before 1970, most short-term U.S.\ consumer credit was extended by merchants; today banks extend it through credit cards. Using the 1978 \emph{Marquette} decision, which unexpectedly ended binding usury regulation, I estimate that the induced 20\% decline in merchant lending raised retail net entry---my proxy for merchant profits---by about 4\%, most for small firms. New establishment-level data on card acceptance, hand-collected from archival Yellow Pages, combined with a model separating cost reduction from merchant substitutability, show lower costs rather than competition drive the effect: banks' scale and risk-bearing cut accepting merchants' costs by roughly 4\%. %96 words 
...
Why have bank credit cards become the dominant form of retail payment in the United States? In particular, did this transition benefit retail firms? More broadly, when does a new technology that unbundles part of the work that firms do (in this case, supplying credit) benefit firms? This paper addresses these questions through the lens of the historical experience of the growth of bank credit cards in the United States. Before 1970, almost all consumer credit in the United States was extended by merchants directly to consumers, both with magnetic cards and more simple recordkeeping systems. Merchants incurred expenses screening customers for creditworthiness and collecting their receivables. Large retailers viewed these activities as a competitive advantage and a core part of their business, as large automakers today still do (\cite{benetton_credit_2022}). Today, large bank credit card networks are nearly universally accepted by all merchants in the United States. Developing countries continue to rely heavily on merchant credit in the absence of deep financial sectors, further motivating the study of the United States' experience. 

This paper estimates the causal effect of an exogenous bank credit card supply increase on outcomes for retail firms, and provides a theoretical framework to decompose changes in profits into changes in markups and changes in costs, where markups summarize the competitive price-setting game between firms. In particular, the net effect of firms' adoption of new credit technology on industry profits can be decomposed into two forces. Firstly, bank credit may be much cheaper to administer than store credit. To the extent that the resulting surplus is not perfectly captured by banks (as swipe fees charged to merchants) nor consumers (as lower prices), retail firms benefit from this mechanism. On the other hand, payment network adoption can be a game of negative externalities between adopting firms with networks exploiting their network effects as market power over the firms, leaving them all worse off despite each firm's individual decision being rational (\cite{rochet_cooperation_2002, rochet_platform_2003, edelman_price_2015, wang_regulating_2023}). This latter concern is rooted in the \emph{network externalities} at the heart of the payments literature: each additional cardholder makes acceptance more valuable to merchants, and each additional accepting merchant makes the card more valuable to consumers, giving the platform leverage over both sides. I engage these forces directly rather than assuming them away, but the evidence in this paper will suggest that the economically decisive product supplied by the card network in this period was credit, not payment processing.

I examine the responses of firm outcomes including lending to customers, profitability, entry, exit, and sales to distinguish these two mechanisms, and find much stronger support for cost-reduction than interoperability. This implies that bank card payment network growth (specifically, in the United States from 1978 to 1983) should be considered a true technological improvement, rather than a zero- or negative-sum transfer from the retail sector to the financial sector. At the most basic level, a bank can extend credit more cheaply than the collection of stores the customer shops at because the bank needs only to screen the customer once, and send one single monthly bill, rather than repeating these activities across all stores. At a more nuanced level, a bank has a large balance sheet and a diverse portfolio of assets that can absorb losses from credit card lending due to adverse economic shocks, while a retailer who experiences a negative local economic shock will face unpaid receivables and declining revenue simultaneously, implying a high price of risk for the retailer.

Stated in terms of the modern institutional arrangement, the mechanism I emphasize is that merchants \emph{outsourced the supply of credit} to the banking system. Card networks supply unsecured revolving credit to consumers through their issuing banks; issuing banks cross-sell cards alongside deposit accounts and other lending products, which affords them both a degree of monitoring and the ability to price discriminate across customers; banks and their acquirers then sell this service to merchants who do not want to be banks themselves; and the merchant discount rate, inclusive of the interchange fee, is the price a merchant pays for access to the network's mass of cardholders, for the onboarding of new customers, and for the maintenance of the existing customer base---with default risk residing on the bank's balance sheet rather than the merchant's. Consistent with this division of labor, \cite{adams_credit_2022} document that even in the modern United States the profitability of credit card banking derives from the provision of credit and its associated fees, not from interchange, which is frequently a loss to issuers net of rewards and operating expenses. The network's product is credit; merchant fees finance the operations that deliver borrowing customers to the point of sale.
...
This paper speaks directly to contemporary policy debates over the regulation of interchange fees---the fees that merchants pay to banks for processing credit card transactions. Recent measures continue to target the fees merchants pay to card networks: in the United States, the Credit Card Competition Act (reintroduced in 2026) would mandate network-routing competition rather than cap fees outright,\footnote{Credit Card Competition Act of 2026, S.~3623 / H.R.~7035, 119th Cong.\ (2026).} and proposals to cap credit-card interest rates remain pending in Congress,\footnote{E.g., the 10 Percent Credit Card Interest Rate Cap Act of 2025, S.~381 / H.R.~1944, 119th Cong.\ (2025).} while binding interchange caps are already in force in the European Union (the Interchange Fee Regulation)\footnote{Regulation (EU) 2015/751 of 29 April 2015 on interchange fees for card-based payment transactions, which caps interchange at 0.3\% of transaction value for consumer credit cards and 0.2\% for debit cards.} and have been proposed by the United Kingdom's payments regulator (\cite{psr_crossborder_2024}). These measures rest on the premise that such fees represent excessive rents extracted from merchants. My findings suggest that this framing may be incomplete: the historical evidence shows that credit card networks fundamentally changed the cost structure of retail by substituting expensive in-house credit operations with bank-provided credit infrastructure. Understanding this historical transition is crucial for evaluating whether modern interchange fees represent a rent or a payment for genuine cost savings, as emphasized by \cite{wang_regulating_2023}. A related strand of this debate emphasizes that interchange-funded rewards may redistribute regressively from cash-paying households to affluent cardholders (\cite{schuh_who_2010}). Without dismissing these distributional effects, my evidence cautions against evaluating the card system on the transfer between payers alone: merchant fees have from the outset financed a system whose core product---outsourced consumer credit---generated first-order cost savings for merchants, particularly small ones, and whose profitability rests on lending rather than on interchange itself (\cite{adams_credit_2022}).

This paper is also related to the large and growing literature on the industrial organization of payments including \cite{rochet_platform_2003}, \cite{edelman_price_2015}, \cite{wang_regulating_2023}, \cite{brunnermeier_mobile_2023}, \cite{agarwal_real_2020}, \cite{huynh_equilibrium_2022}, \cite{arango_consumer_2015}, \cite{huynh_role_2014}, \cite{evans_paying_2004}. These models typically seek to explain, e.g., the structure and levels of network fees to each side of a multi-sided market in terms of price elasticities. My model is agnostic to the forces determining network fees, and takes as given the outcome of the network game bargaining process, resulting in a cost savings term inclusive of merchant fees paid to the network. These models typically assume that the network is a middleman who garners excessive use of the network through the differentiated fee structure leading to deadweight loss. I take a more reduced-form, aggregate perspective to quantitatively compare such frictions to the benefits of technological improvement in the credit card market, finding the latter to be first order. My decomposition of demand is complementary to the consumer payment-instrument-choice literature (\cite{koulayev_explaining_2016}, \cite{arango_consumer_2015}), which models how a consumer pays \emph{conditional} on a purchase, and to the structural two-sided-market analysis of \cite{huynh_equilibrium_2022}, who jointly estimate consumer adoption and merchant acceptance of payment methods on rich consumer- and merchant-side microdata. These literatures decompose the choice of \emph{payment instrument}; my structural exercise instead decomposes preference over \emph{retailers} into a product-taste component and a payment-method-acceptance component. The closest decompositions appear in the recent ``buy now, pay later'' literature---\cite{berg_economics_2025} model BNPL as bundling a sale with a subsidized loan to price-discriminate across consumers, and \cite{aidala_understanding_2025} decompose demand for different features of a BNPL contract.

At an even higher level, this paper relates to literature on credit expansions including \cite{beck_finance_2008}, \cite{beck_big_2010},  \cite{kroszner_regulation_2014}, \cite{jayaratne_entry_1998}, \cite{kroszner_what_1999}, \cite{chong_effects_1991}, \cite{schularick_credit_2012}, \cite{mian_what_2014}, \cite{mian_how_2020}, \cite{julia_fonseca_how_nodate}, \cite{herkenhoff_impact_2021}, and \cite{muller_credit_2023}. Credit expansions are typically viewed with macroprudential suspicion as a tradeoff between the mean level of economic growth and risk of recession (its variance). My contribution is to evaluate the source and technology of credit supply, rather than the one-dimensional tradeoff of more vs less credit. I argue that credit products offered by specialized and diversified banks offer a superior technology, in terms of cost, to store credit, and are a win-win for firms and consumers. 
...
Federal regulation of the credit relationship itself also shifted the calculus between in-house and bank credit in the mid-1970s. The Equal Credit Opportunity Act of 1974 prohibited discrimination in any credit transaction on the basis of sex or marital status, and its March 1976 amendments extended the prohibition to race, color, religion, national origin, age, and receipt of public assistance income.\footnote{Pub.\ L.\ 93-495, title V (1974); Pub.\ L.\ 94-239 (1976). The Act's congressional champions were themselves familiar with the arbitrariness of prevailing practice: Representative Margaret Heckler, a member of the House Banking Committee and a leading sponsor, had in the 1960s been refused a credit card unless her husband co-signed---while she was a sitting member of Congress. See \cite{hyman_debtor_2012} on the history of credit discrimination and the Act's passage.} Crucially, the Act applies to \emph{any} creditor who regularly extends credit---a department store operating charge accounts as much as a money-center bank. For a retailer, the Act converted in-house credit from a simple merchandising tool into a regulated financial activity carrying compliance obligations (nondiscrimination standards and adverse-action notice requirements under Regulation B) and litigation exposure, and it did so while giving every customer at the register---including the lower-income and protected-class customers a store's charge office might previously have turned away informally---a statutorily protected claim to a fairly evaluated credit application. A specialized bank can spread these fixed compliance costs across millions of accounts; a merchant cannot. The timing is suggestive: aggregate bank credit card lending begins its takeoff around 1975 (Figure \ref{fig:total_card_growth}), between the Act's passage and its broadened 1976 amendments, with \emph{Marquette} then removing the remaining price constraint in 1978. Because the Act applied nationwide, it does not confound the cross-state identification strategy below; rather, it is a complementary nationwide force that raised the relative cost of supplying credit in-house and reinforced merchants' incentive to outsource credit supply to banks.
...
\begin{figure}[!ht]
    \caption{Credit Card Spending on Bank vs. Store Cards, 1970-2019}\label{fig:bank_store}
     ...
     \begin{subfigure}[b]{0.32\textwidth}
         ...
         \caption{Spending, share of income}
     \end{subfigure}
     \hfill
     \begin{subfigure}[b]{0.32\textwidth}
         \centering
         \includegraphics[width=\textwidth]{../Output/Figures/store_fraction.pdf}
         \caption{Store-card share of cardholders}
     \end{subfigure}
     \hfill
     \begin{subfigure}[b]{0.32\textwidth}
         \centering
         \includegraphics[width=\textwidth]{../Output/Figures/cards_per_household.pdf}
         \caption{Cards per household}
     \end{subfigure}
          \end{center}
     \noindent \small \uline{Notes:} The figure shows the change in composition of credit card supply since 1970 (the first year in which the SCF inquired about credit cards). Panel (a) shows bank- and store-card spending normalized by nominal income; panel (b) shows the store-card share of cardholders; panel (c) shows the average number of bank and store cards per household. ``Store Cards'' are cards that are only usable at specific stores, i.e. non-interoperable. Interoperable cards with store-specific branding are bank cards. Averages are weighted by SCF sample weights.
\alttext{Three-panel line chart from the Survey of Consumer Finances, 1970--2019. Panel (a): bank-card spending as a share of income rises steadily while store-card spending falls toward zero. Panel (b): the store-card share of cardholders declines from a majority in 1970 to a small minority. Panel (c): the average number of bank cards per household rises while store cards decline.}
\end{figure}

Figure \ref{fig:bank_store} shows the changing composition of consumers' revolving credit over time. Panel (a) shows that the relative amount of credit card spending financed by stores (as opposed to banks\footnote{Following the SCF, I use "banks" to include all financial institutions, not necessarily those with ``banking licenses'' per se}) has been steadily declining since 1970: from 1970--1971, nearly 75\% of total card spending was on store credit cards, and as of 2019 that figure is less than 10\%. Panels (b) and (c) show the same transition in the share of cardholders who hold a store card and in the number of bank versus store cards per household. Bank credit cards proceeded to proliferate throughout the 1960s, and in 1970 the SCF added questions about credit cards to the survey for the first time, prefacing the question with ``There is a lot of talk about credit cards these days.'' Since the SCF tracks store credit borrowing in terms of balances, but credit cards in terms of spending amounts, I take the most conservative possible approach and only compare store credit card spending to bank credit card spending starting in 1970; the fraction of credit extended by stores early in the sample would be higher if I were to additionally attempt to estimate the flow of spending using store credit.

The replacement of store cards by bank cards was accompanied by sustained growth in the total mass of consumers carrying bank cards, a fact that matters for merchants' acceptance incentives and to which I return in Section \ref{sec:model}. Figure \ref{fig:card_income} plots the share of households holding a bank credit card by within-year income quartile in the SCF. The central fact for this study concerns the 1970--1983 window bracketing \emph{Marquette}: bank card ownership among top-quartile households rose from 35\% in 1970 to nearly 75\% by 1983, while ownership in the bottom quartile started at 4\% and never cracked 20\%. During the period under study, then, the bank card was not a uniform shifter of demand across the customer population. What acceptance delivered to a merchant was, disproportionately, access to high-income customers---an acquisition vehicle for exactly the affluent, high-margin clientele that retailers compete hardest to capture. Ownership did eventually diffuse down the income distribution (by 2019, 95\% of top-quartile and 45\% of bottom-quartile households held a bank card), but throughout the study period the marginal cardholder delivered by the network sat firmly in the upper half of the income distribution. From the perspective of an accepting merchant, each new cardholding household enlarges the customer base reachable through the network without any in-house screening; this expanding---and, in this period, affluent---mass is the network externality operating on the revenue side.

\begin{figure}[!ht]
 \caption{Bank Credit Card Ownership by Income Quartile}\label{fig:card_income}
 \vspace{-0.25cm}
 \begin{center}
  \includegraphics[width=.8\textwidth]{../Output/Figures/bank_card_by_income.pdf}
  \end{center}
  \noindent \small \uline{Notes:} The figure shows the fraction of households holding at least one bank credit card by income quartile in the Survey of Consumer Finances. Income quartiles are computed within each survey year using SCF sample weights. Year-quartile cells with fewer than 100 respondents are omitted.
\alttext{Line chart of the share of households holding at least one bank credit card, by within-year income quartile, 1970--2019. Ownership is ordered by income throughout: the top quartile rises from 35\% in 1970 to nearly 75\% by 1983 and 95\% by 2019; the bottom quartile remains below 20\% through 1983 and reaches 45\% by 2019.}
\end{figure}
...
\alttext{Line chart of the average quarterly ratio of outstanding receivables to revenue for retail and for wholesale firms from the Quarterly Financial Reports since 1980; receivables of retail firms decline over the period.}
\end{figure}
...
\begin{figure}[!htp]
 \caption{Share of the Retail and Wholesale Wage Bill Paid to Bookkeepers and Bill Collectors}\label{fig:backoffice_retail}
 %\vspace{-0.25cm}
 \begin{center}
...
\alttext{Line chart, 1940--2020: the share of the retail-sector wage bill paid to bookkeepers and bill collectors falls smoothly from over 4\% in 1940 to under half a percent by 2020.}
\end{figure}
%\vspace{-0.5cm}

I conclude this section by considering the international cross-section of countries by composition of consumer credit. This is important because other countries may wish to learn from the experience of the United States when considering the regulation of consumer finance in their own countries. Using the World Bank Findex (See Appendix \ref{sec:data} for details), I create Figure \ref{fig:international}, which plots the cross-country distributions of credit card ownership (panel a) and store credit access (panel b), with the United States marked in each. The United States sits at the right tail of credit card ownership, with credit card ownership more than 4x higher than store credit usage. Many prominent developing countries have much higher rates of store credit borrowing and almost all have much lower usage of credit cards. Therefore, while it may not be the case in the United States today that the cost and risk to businesses of issuing store credit to their customers is first-order, as bank credit cards have come to dominate in the equilibrium which exists in the United States today, the findings herein may be of importance for developing economies weighing the costs and benefits of expanding the consumer credit supply of banks. No causal claims can be made from this exercise, but it is instructive to know that credit card ownership ranges from near 0 to about 80\% across countries and store credit usage from near 0 to about 45\%, with the United States toward the high end of card ownership and the low end of store-credit reliance.

\begin{figure}[!htp]
 \caption{Credit Cards and Store Credit Internationally, 2011-2017}\label{fig:international}
 \vspace{-0.25cm}
 \begin{center}
  \includegraphics[width=.9\textwidth]{../Output/Figures/international_histograms.pdf}
  \end{center}
...
\alttext{Two histograms across countries from the World Bank Global Findex (most recent year per country): the distribution of credit card ownership rates and the distribution of store credit usage rates.}
\end{figure}
...
Equations \ref{eq:decomposition} and \ref{eq:decomposition2} also make precise where a network externality enters the merchant's problem, and they do so without committing to any model of the platform's fee-setting game. The first term---the (new) markup multiplied by the change in revenue---is the profit earned at the going markup on any change in the volume of business, and this is exactly the margin on which the network externality operates: joining an interoperable network connects a merchant to the network's entire mass of card-carrying consumers, so as that mass grows, $\Delta \mathrm{Revenue}$ rises for accepting firms even with conduct unchanged. Figure \ref{fig:card_income} documents that this mass of consumers expanded continuously throughout the sample period and beyond, so the externality is not a one-time adoption event but an ongoing flow of new customers delivered to accepting merchants. Moreover, during the 1970--1983 study window that flow was concentrated among high-income households---top-quartile ownership reached nearly 75\% by 1983 while bottom-quartile ownership remained below 20\%---so the revenue the network delivered to accepting merchants was not a uniform demand shift but was skewed toward affluent, high-margin customers, raising $\Delta \mathrm{Revenue}$ per cardholder beyond what a population-average customer would imply. The second term, $\Delta \mu$, captures the adversarial face of the same externality emphasized by the two-sided-market literature: interoperability makes accepting merchants closer substitutes for one another, compressing markups. The decomposition therefore nests the network externality---its revenue-expanding side in the first term and its competition-intensifying side in the second---while remaining agnostic about the platform conduct that generates them.

The same selection that skews $\Delta \mathrm{Revenue}$ toward affluent customers also operates on the cost side. Recall that $C_t$ is defined inclusive of default losses on receivables. A household holds a bank card only if a bank has screened it and judged it creditworthy, and Figure \ref{fig:card_income} shows that during the study window the qualifying population sat firmly in the upper half of the income distribution. When a merchant begins accepting the card, the customers the network delivers are therefore drawn from a pool that is pre-screened, disproportionately high-income, and financially stable: the default component of the merchant's cost falls not only because the bank now bears the credit risk, but because the composition of the merchant's credit-using customer base improves. This is, in a sense, the central message of the paper: merchants accept credit cards not merely to boost revenue per se, but to fill their stores with the type of customer who can qualify for a credit card. The channel is specific to the \emph{credit} function of the card. An instrument that merely moves money---a debit card, or a modern payment app such as Venmo or Pix---performs no underwriting and therefore delivers no such selection.
...
\alttext{Two histograms of bank credit card interest rates from the Survey of Consumer Finances. In 1977, reported rates bunch sharply at common usury ceilings such as 18\%; by 1983 the bunching at ceilings is much weaker.}
\end{figure}

Usury regulation was especially potent due to the prevalence of inflation at the time. In the U.S. today, personal loan interest rate ceilings are often set at 36\%. Figure \ref{fig:usury_ts} makes the bind starkly visible: the \emph{minimum} usury ceiling across states stood at just 10\% through 1982, yet inflation reached 13.5\% in 1980 and the federal funds rate---a lower bound on banks' own cost of funds---climbed above 16\% in 1981. In the most-constrained states, then, a bank lending at the legal ceiling earned a deeply negative real return and could not even cover its cost of funds, so profitable card lending was essentially impossible until \emph{Marquette} lifted the cap. Even the modal ceiling of 18\% left little margin once default and servicing costs are netted out. I am therefore highly confident that the effect of \emph{Marquette} to deregulate these usury limits was material.
...
\begin{figure}[!ht]
 \caption{Usury Limits, Inflation, and the Federal Funds Rate}\label{fig:usury_ts}
 \vspace{-0.25cm}
 \begin{center}
  \includegraphics[width=.9\textwidth]{../Output/Figures/inflation_ts.pdf}
  \end{center}
  \noindent \small \uline{Notes:} The figure plots, for 1971--1990, the U.S.\ inflation rate and the federal funds rate (a lower bound on banks' marginal cost of funds) as solid lines, and two summaries of state usury ceilings as dashed lines: the minimum (most-binding) limit across states and the modal limit. The minimum ceiling of 10\% sat well below both inflation and the federal funds rate as they peaked around 1980, indicating how severely the caps bound before \emph{Marquette}.
\alttext{Line chart, 1971--1990: U.S.\ inflation and the federal funds rate (solid lines) against the minimum and modal state usury ceilings (dashed lines); around 1980 inflation and the federal funds rate peak well above the minimum ceiling of 10\%.}
\end{figure}
...
\alttext{Time-series chart of aggregate bank credit card lending from the Call Reports, with states that abolished usury limits by 1982 shown separately; aggregate lending accelerates from the mid-1970s.}
\end{figure}
...
\alttext{Choropleth map of the United States showing each state's maximum legal interest rate for consumer lending in 1977; states with ceilings below 18\% form the treated group.}
\end{figure}
\vspace{-0.5cm}
...
I rely on estimates produced by \cite{zinman_impact_2003}\footnote{These estimates rely on nonpublic SCF state-of-residence data which cannot be released to researchers outside of the Federal Reserve.} to calculate the increase in bank credit card supply from the consumer side, and complement them with original estimates from the firm side to estimate the extent to which bank credit crowded out store credit. 
...
\alttext{Three event-study panels of yearly triple-difference coefficients (omitted year 1977) for clothing retail by county: total establishments, establishments with fewer than 20 employees, and the fraction of small establishments, each with confidence intervals.}
\end{figure}
...
\input{../Output/Tables/compustat_regressions.tex}
...
\input{../Output/Tables/adoption_firms.tex} 
\end{table}
...
I close the model with an assumption about cost and quality. In this model, cost and quality are not separately identified -- an increase in product quality of $x$ is equivalent to a cost reduction of $\alpha x$. Therefore I assume that product quality $\xi$ is held constant across counterfactuals, but that cost $c_j$ may change. In particular, the cost $c_j$ is normalized to 1, but changes if the firm accepts the bank credit card. A fraction $f(g)$ of consumers use credit card network $g$. The firms' cost is $1+\zeta f(g(j))$. Therefore the base cost of the industry with all $g$ being singleton networks (single store card networks) is the numeraire of the model.

The interpretation of the cost shifter $\zeta$ deserves emphasis. Because cost and quality are not separately identified, $\zeta$ is inclusive of quality improvements: if some consumers simply derive more utility from paying with a bank card than with store credit or cash---as when consumers hold preferences over payment instruments themselves, e.g. \cite{wang_regulating_2023}---that utility gain is observationally equivalent to a cost reduction of the corresponding magnitude and loads onto $\zeta$. The decomposition the model delivers is therefore not between ``cost'' and ``demand'' in a narrow accounting sense, but between the component of a new payment and credit technology that is a Pareto improvement---cost reductions and quality improvements alike, absorbed by $\zeta$---and the component that is not: the change in differentiation between firms, absorbed by $\sigma$. The customer-selection channel documented in Figure \ref{fig:card_income}---accepting merchants draw their credit-using customers from the pre-screened, disproportionately affluent population of cardholders---provides a concrete microfoundation for $\zeta < 0$.
...
To estimate this model, I first construct a sample of establishments which appear in the Yellow Pages as accepting or not accepting bank credit cards (as described in Appendix \ref{sec:construction}) and which appear in 1977 with verified revenue values and survive at least 2 years. For each establishment, I calculate the annual average sales growth\footnote{$tmax$ is the last year the establishment is observed. I winsorize the growth rate at +100\% per year.}
\begin{equation*}
Salesgrowth_i = \frac{\log(SLS_{tmax}) - \log(SLS_{1977})}{tmax - 1977}.
\end{equation*} Then, I estimate the effect of the \emph{Marquette} shock in 1978 on these establishments using the estimating equation: 
...
\caption{Decomposing the Effect of Bank Cards}\label{tab:counterfactuals}
    \centering
    \input{../Output/Tables/counterfactuals.tex}
...
\alttext{Line chart of the U.S.\ unemployment rate since 1948 with NBER recessions shaded; unemployment peaks near 11\% in the 1982--83 recession.}
\end{figure}
...
Table \ref{tab:dif-dif-recession} reports the results of Equation \ref{eq:dif-dif-recession}. Overall, higher-sales establishments are more likely to survive, confirming intuition. During the recession, single-establishments fail at a much higher rate than branches, which also confirms intuition. This holds true regardless of whether the states saw an increase in bank card usage (treatment), and pre- and post-Marquette. The difference appears with the 1983 recession, post-Marquette, when single-establishment firms survived at a 1.6\% higher rate in treated states relative to untreated states (significant at the 10\% level). In high-adoption (clothing) industries, this is larger at 2.0\% (significant at the 5\% level).
...
\noindent \small \uline{Notes:} OLS estimates of Equation \ref{eq:dif-dif-recession}. The dependent variable is the establishment exit rate. Columns split by recession year (1983 vs.\ the 1975 placebo) and by sample (all retail vs.\ clothing retail, SIC 56). The coefficient of interest is $Treated\times Recession\times Single$. Fixed effects are State$\times$Industry$\times$Year; standard errors are clustered by state.
\end{table}
...
Debates over how much lending should occur in an economy, and on what terms, are some of the oldest economic debates in history (\cite{glaeser_neither_1998}). I draw attention to the fact that the technologies used to supply credit matter greatly when answering this question. In particular, specialized credit suppliers such as banks may be superior at such activities for reasons such as economies of scale and the diversification of risk. While merchants complain about paying high fees for something that they view as a simple risk-free transaction, the equivalent of cash, the seeming simplicity of a credit card to the consumer and the merchant belie the complexity and risk of month-to-month lending in a modern global economy with frequent transactions between counterparties without trust. The evidence presented here suggests that merchant discount fees are far less than the cost to perform screening and collection activities in-house, and that small merchants are those who benefit most. The customer-selection channel admits a compact statement of the paper's message: merchants accept credit cards not merely to boost revenue, but to fill their stores with the type of customer who can qualify for one.

These findings have direct implications for contemporary policy debates over the regulation of interchange fees. The historical evidence suggests that credit card networks created genuine cost savings for merchants, particularly small ones, rather than merely redistributing surplus from merchants to banks. Policymakers evaluating proposals to cap interchange fees should weigh these cost savings against any rents extracted by networks, recognizing that the net effect of credit card infrastructure on merchants has historically been positive (\cite{wang_regulating_2023}). The modern evidence that credit card profitability derives from the provision of credit rather than from interchange (\cite{adams_credit_2022}) is consistent with the historical account offered here: the card system's product is outsourced consumer credit, and merchant fees are best understood as financing the operations that maintain and expand the match between merchants and a card-carrying customer base, not as the system's profit center. Developing countries should not discount the high labor and risk costs borne by small businesses nor ignore such credit, however difficult to measure, when evaluating costs and benefits of enabling greater consumer financialization in their economies.
...
\begin{figure}[!ht]
     ...
     \end{subfigure}
        ...
        \label{fig:ustd}
\alttext{Two scanned Yellow Pages excerpts showing merchant listings under bank card program headings (BankAmericard and Master Charge), the raw records used to code credit card acceptance.}
\end{figure}

From these data, I identify the firms most likely to be early adopters of bank cards and their characteristics, which are informative about the mechanisms which incentivize firms to accept bank cards. Table \ref{tab:card_uses} shows the fraction of firms by industry which adopt bank cards in the 1970s, and compares to the categories of goods purchased with store and bank cards reported by households in the 1971 SCF. These results motivate the heterogeneity analyses by industry in Section \ref{sec:profits}. These data are also the basis of empirical tests in Sections \ref{sec:adoption_effects} and \ref{sec:adoption_effects} which seek to distinguish between the two major mechanisms of cost-reduction and payment friction reduction. 

\subsection{County Business Patterns}

I collect data on establishment counts across the size distribution of businesses from the US Census' County Business Patterns. These data available are available at an annual frequency since 1946 (\cite{eckert_early_2022}). These data are suitable for examining heterogeneous effects across the size distribution of firms, and aggregate net entry of firms which I argue is a sufficient statistic for economic profits. I aggregate data by year, county, and 2-digit SIC code. Of particular interest is the clothing retail industry, where I hypothesize that the effect of bank credit cards should be apparent, if it exists. As Table \ref{tab:card_uses} shows, clothing was the predominant use of both store and bank credit cards as of 1970. The clothing retail industry is characterised by a larger number of establishments, but fewer total employees, than other similarly-defined industries, indicating a larger fraction of smaller businesses. The second panel of Table \ref{tab:card_uses} is compiled from the 1971 Survey of Consumer Finances. Among holders of store cards and, separately, among holders of bank cards, I tabulate the share reporting each consumer-item category as what they purchase with the card; clothing is the most common use for both card types, consistent with the industry-acceptance pattern in the first panel. 
...
%\vspace*{-0.5cm}
\resizebox{.55\textwidth}{!}{\input{../Output/Tables/card_acceptance_by_industry.tex}}
\quad
\resizebox{.45\textwidth}{!}{\input{../Output/Tables/card_uses.tex}}
%\end{center}
\uline{Notes:} The first panel describes the fraction of firms across (2-digit SIC code) industries which accept bank credit cards in the US Telephone Directories data. Construction of these data using Dun \& Bradstreet and the US Telephone Directories is described in Appendix \ref{sec:construction}. The second panel describes the share of store-card holders and of bank-card holders in the 1971 Survey of Consumer Finances who report purchasing each category of goods with the card; respondents could name up to three categories, so shares need not sum to 100\%. 
\end{table}
...
\begin{figure}[H]
 ...
 \begin{center}
  ...
  \end{center}
\alttext{Bar chart of the number of phone books in the Library of Congress US Telephone Directories collection per year since 1950, colored by state.}
\end{figure}
\vspace{-0.5cm}
...
\alttext{Map of US counties covered by the US Telephone Directories collection, shaded in blues by the lower bound on the possible introduction date of bank credit cards.}
\end{figure}
\vspace{-0.5cm}
...
\centering
\input{../Output/Tables/yp_county_repr.tex}
\newline
...
\centering
\input{../Output/Tables/yp_representativeness.tex}
\newline
...
\centering
\input{../Output/Figures/yp_review/ocr_full_summary.tex}
\newline
...
\end{subfigure}
\alttext{Two panels summarizing the machine-readable phonebook corpus: counts of phonebooks by state and year, and the first year a ``Credit Card'' section appears in each book.}
\end{figure}
\vspace{-0.25cm}

\noindent The full corpus, the hand-transcribed credit card acceptance records, a data dictionary, and the code that produces every figure and table in this section \ifblind are archived in a public data repository and mirrored in the paper's public replication repository (links redacted for peer review). \else are archived on Zenodo at \href{https://doi.org/10.5281/zenodo.20513427}{\texttt{doi.org/10.5281/zenodo.20513427}} and mirrored in the paper's public replication repository. \fi Because the corpus derives from public-domain materials, it may be freely reused; the proprietary Dun \& Bradstreet records used to attach establishment sales are not redistributed and must be licensed separately.

\newpage

\section{Summary Statistics}\label{sec:summary-stats}

\input{../Output/Tables/summary_scf.tex}
...
\alttext{Histograms of credit card interest rates reported in the Survey of Consumer Finances, with respondents grouped by whether their largest balance is on a store or a bank credit card.}
\end{figure}
\vspace{-0.5cm}
...
\input{../Output/Tables/summary_cbp.tex}
...
\centering
\input{../Output/Tables/treatment_balance.tex}
\newline
...
\centering
\input{../Output/Tables/compustat_summary.tex}
\newline
...
\centering
\input{../Output/Tables/yp_summary.tex}
\newline
...
\begin{figure}[H]
 \caption{Mean Credit Card Interest Rate and Zero-Rate Share, 1977--2019}\label{fig:card_rates_raw}
 \vspace{-0.25cm}
 \begin{center}
...
\alttext{Line chart, 1977--2019: the mean interest rate on credit cards from the Survey of Consumer Finances, with the share of cards carrying a zero interest rate overlaid.}
\end{figure}
...
\alttext{Scatter plot relating states' 1977 usury ceilings to their average year of banking deregulation; the correlation is near zero.}
\end{figure}
...
\alttext{Cumulative distribution of placebo estimates of the 1983 coefficient from permuting usury treatment across states (black curve), with the empirical point estimate marked by a red vertical line in the upper tail; the one-sided permutation p-value is 0.07.}
\end{figure}
\vspace{-0.5cm}
...
\alttext{Scans of two newspaper articles from 1959--1969 covering merchant credit plans and legislation to curb unsolicited credit cards.}
\end{figure}
