...
\setbeamertemplate{title page}{%
  ...
  \begingroup
    ...
    \vskip0.5em\par
    \begin{beamercolorbox}[sep=8pt,center]{institute}
      {\scriptsize Code \& public data: \url{https://github.com/josephhall5959/consumer-finance}}
    \end{beamercolorbox}%
  \endgroup
}
\makeatother
...
\begin{itemize}\setlength\itemsep{0.05em}
    ...
    \item Calibration asks: \textbf{how much does the nest matter for where consumers shop?} 
\end{itemize}
...
\vspace{0.2em}
{\footnotesize $\alpha$ (price sensitivity) is calibrated from the literature (and doesn't affect the answer in sensitivity analyses); only $\sigma$ and $\zeta$ (the cost change) are matched. Two moments, two parameters --- exactly identified.}
...
\vspace{0.6em}
{\footnotesize \textbf{First} decomposition of demand for \emph{retailers} (vs.\ the well-studied choice of payment instrument) into product taste vs.\ payment-method taste: 95\% CI bounds $\sigma$ above at $\approx0.07$.}
...
\begin{itemize}
    ...
    \item Capping fees may push merchants back toward costly in-house credit
...
\centering
\small
\input{../Output/Tables/card_acceptance_by_industry}
\end{frame}
